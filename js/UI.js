export const UI_ELEMENTS = {
    CHAT: document.querySelector('.chat-main'),
    ...
    CLOSE_VALIDATION : document.querySelector('.popup-close-validation'),
    INPUT_VALIDATION : document.querySelector('#input_validation'),
    BUTTON_VALIDATION : document.querySelector('#button_validation'),
    INPUT_SETTINGS : document.querySelector('#input_settings'),
    BUTTON_SETTINGS : document.querySelector('#button_settings'),
}
